...
// function Work() {
//   const tabs = ["전체", "반응형웹", "UI/UX", "IDENTITY", "LOGO"];
//   const [activeTab, setActiveTab] = useState("전체");
//   const [visibleCount, setVisibleCount] = useState(6); // 처음 보일 카드 수
...
//               <Link to={item.url} key={item.id} className={styles.card}>
...
//                     {/* ✅ 여기 수정 */}
//                     {/* <p className={styles.category}>{item.category.join(" · ")}</p> */}
...
function Work() {
  const tabs = ["ALL", "반응형웹", "WEB", "UX/UI", "IDENTITY", "LOGO"];
